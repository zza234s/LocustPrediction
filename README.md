...
## Demo Video
[![Demo Video](https://img.youtube.com/vi/HA5PW2s1BaA/maxresdefault.jpg)](https://www.youtube.com/watch?v=HA5PW2s1BaA)
## Intended use 
...
```bash
bash LocustLens-SFT-RL-4B_test.sh
```

### RL training script

```bash
bash LocustLens_RL_traininig.sh 
```

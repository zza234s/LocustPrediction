...
elif vs.parse(package_version) >= vs.parse("0.7.0") or  package_version=="0.1.dev12552+g7eeabc339.precompiled":
    vllm_version = package_version
    if vs.parse(package_version) >= vs.parse("0.8.5") or package_version=="0.1.dev12552+g7eeabc339.precompiled":
        VLLM_SLEEP_LEVEL = 2
    from vllm import LLM
    from vllm.distributed import parallel_state
else:

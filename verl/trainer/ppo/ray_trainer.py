...
class RayPPOTrainer:
    ...
    def _validate(self):
        ...
        for test_data in tqdm(self.val_dataloader, desc="Validation"):
            ...
            ##########################
            pred = result['reward_extra_info']['pred']
            label= result['reward_extra_info']['label']
            sample_pred_list.extend(pred)
            sample_label_list.extend(label)
            ##########################

        acc = accuracy_score(sample_label_list, sample_pred_list)
        ...
        metric_dict['val-core/locust/acc']=acc
        return metric_dict
